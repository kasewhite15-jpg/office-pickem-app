...
import {
Trophy, Award, CheckCircle2, XCircle, ChevronUp, ChevronDown,
Sparkles, RefreshCw, Layers, Shield, HelpCircle, Save, Check
} from 'lucide-react';
...
<div>
<h1 className="text-xl font-bold tracking-wide text-white">Office Confidence Pool</h1>
<p className="text-xs text-slate-400">Week 1 • 10 Games • Max 55 Pts</p>
</div>
</div>
...
<span className="text-xs text-slate-400 font-medium">MNF Total Points:</span>
<input
type="number"
value={tiebreaker}
